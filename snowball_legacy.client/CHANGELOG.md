...
- Create Angular project with ng: `ng new snowball_legacy.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`snowball_legacy.client.esproj`).
